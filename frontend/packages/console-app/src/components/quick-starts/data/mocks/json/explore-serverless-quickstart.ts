...
In the Status column of the **Installed Operators** page, is the OpenShift Serverless Operator’s status **Succeeded?**`,
          failedTaskHelp: `This task is incomplete. Try the task again, or [read more](https://access.redhat.com/documentation/en-us/openshift_container_platform/4.7/html/serverless/administration-guide#install-serverless-operator) about this topic.`,
        },
...
`,
          failedTaskHelp: `This task isn’t verified yet. Try the task again, or [read more](https://access.redhat.com/documentation/en-us/openshift_container_platform/4.7/html/serverless/administration-guide#installing-knative-serving) about this topic.`,
        },
        summary: {
