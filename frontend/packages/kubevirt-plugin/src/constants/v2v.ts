...
export const VMWARE_DOCURL =
  'https://access.redhat.com/documentation/en-us/openshift_container_platform/4.7/html/openshift_virtualization/virtual-machines#virt-importing-vmware-vm';
export const OVIRT_DOCURL =
  'https://access.redhat.com/documentation/en-us/openshift_container_platform/4.7/html/openshift_virtualization/virtual-machines#virt-importing-rhv-vm';
